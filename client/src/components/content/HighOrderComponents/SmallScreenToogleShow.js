...
const SmallScreenToogleShow = (OriginalComponent) => {
  ...
  function NewComponent() {
    ...
    const toogleHeadModulesClass =
      !home || smallScreenMenuIsOpened ? classes.show : classes.hide

    const toogleSmallScreenMenuClass =
      isSmallScreen && smallScreenMenuIsOpened
        ? classes.showMenu
        : classes.hideMenu
    const toogleContentClass =
      isSmallScreen && smallScreenMenuIsOpened ? classes.hide : classes.show
